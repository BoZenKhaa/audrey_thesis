\chapter{Dietary B vitamin and methionine intake and \emph{MTHFR} C677T genotype on risk of colorectal tumours in patients with Lynch Syndrome: the GEOLynch Cohort Study} 
\label{chap6_lynch}
...
\begin{flushleft}
\small
\tablecaption{Baseline characteristics of the population by total energy-adjusted folate intake.}
\label{table6_1}
\tablehead{}
...
\begin{landscape}
\small
\tablecaption{Hazard ratios for B vitamin and methionine intake and colorectal tumour risk in MMR mutation carriers.}
\label{table6_2}
\tablehead{}
...
\begin{landscape}
\small
\tablecaption{Adjusted hazard ratiosa for B vitamin and methionine intake and development of colorectal tumours stratified by \emph{MTHFR} C677T genotype.}
\label{table6_3}
\tablehead{}
...
~
 &
\multicolumn{2}{m{4.276cm}}{\centering
\bfseries Folate} &
\multicolumn{2}{m{4.275cm}}{\centering
\bfseries Vitamin B2} &
\multicolumn{2}{m{4.497cm}}{\centering
\bfseries Vitamin B6} &
\multicolumn{2}{m{5.05cm}}{\centering
\bfseries Vitamin B12} &
\multicolumn{2}{m{4.731cm}}{\centering
\bfseries Methionine}\\\hline
