...
%Page geometry  
\usepackage[paperwidth=174mm, paperheight=244mm, inner=22mm, outer=19mm, top=22mm, bottom=22mm, hcentering=false, includeheadfoot]{geometry}
...
\usepackage{textpos} % for the chapter pages citation at bottom of page
...
\lhead[\emph{\leftmark}]{{}} % chapter name on the top left corner
\chead{}
...
\usepackage{hyperref} % for supertabular package in addition to others
 \hypersetup{bookmarks=true,colorlinks=false, urlbordercolor=0.1 0.2 0.7,pdfmenubar=true, hyperfootnotes=true,hyperfigures=true,hyperindex=true,pdfstartview=FitH}
...
\large{across a continuum of differential risk for colorectal cancer}\\
  ...
  \bigskip
  \bigskip
  \normalsize{An academic essay in Medical Sciences}\\
\quad\\
\quad\\
  {\large Doctoral thesis}\\
\quad\\
\quad\\
  \normalsize{to obtain the degree of doctor\\
  \smallskip
  ...
  {\large Audrey Jung}\\
\qquad\\
  \normalsize{born in Kamloops, Canada}\\
  \smallskip
\end{center}
...
\phantomsection % allow chapter headings to show up
\lhead[\emph{\leftmark}]{{}}
