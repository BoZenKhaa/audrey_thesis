...
\parbox[t][5cm]{2.1cm}{\centering 800 $\mu$g folic acid or placebo daily for three years} &
...
\hline
\parbox[t][2.5cm]{1.8cm}{\flushleft Fenech \textit{et al}. 1998 \cite{c796}} &
\parbox[t][1.5cm]{1.6cm}{\centering 63 volunteers} &
\parbox[t][1.5cm]{1.6cm}{\centering 18-32 years} &
\parbox[t][1.5cm]{1.8cm}{\centering 2000 $\mu$g folic acid and 20 $\mu$g vitamin B12} &
\parbox[t][1.5cm]{1.3cm}{\centering 12 weeks} &
\parbox[t][1.5cm]{3.2cm}{\centering Methyl acceptance assay} &
\parbox[t][1.5cm]{1.5cm}{\centering Australia} &
\parbox[t][1.5cm]{1.8cm}{\centering No effect}\\

\parbox[t][2.5cm]{1.8cm}{\flushleft Basten \textit{et al}. 2006 \cite{c797}} &
...
\parbox[t][3cm]{1.8cm}{\flushleft Jung \emph{et al}. 2011 \cite{c798} Chapter 4} &
\parbox[t][2cm]{1.6cm}{\centering 216 volunteers} &
\parbox[t][2cm]{1.6cm}{\centering 50-70 years} &
\parbox[t][2cm]{1.8cm}{\centering 800 $\mu$g folic acid} &
\parbox[t][2cm]{1.3cm}{\centering 3 years} &
\parbox[t][2cm]{3.2cm}{\centering Liquid chromatography electron spray tandem mass spectrometry (LC-ES MS/MS)} &
\parbox[t][2cm]{1.5cm}{\centering Netherlands} &
...
%\hline
%\parbox[t][]1.5cm]{2.1cm}{\flushleft {Jacob} {\textit{et al}}{. 1998 \cite{c73}}} &
%\parbox[t][]8 post-menopausal women &
%\parbox[t][]49-63 years &
%\parbox[t][]{ day 1-5 195 $\mu$g/day folate} { day 6-41 56 $\mu$g/day folate}{ day 42-69 111 $\mu$g/day folate} { day 70-80 286 $\mu$g/day folate} day 81-91 516 $\mu$g/day folate &
%\parbox[t][]{Methyl }acceptance assay &
%\parbox[t][]United States of America &
%\parbox[t][]{ Following folate depletion, increased \textsuperscript{3}Hmethyl incorporation} ~ Following repletion (286-516 $\mu$g/day folate), decreased \textsuperscript{3}Hmethyl incorporation\\
%
%{Rampersaud }{\textit{et al}}{. 2000 \cite{c74}} &
%30 post-menopausal women &
%60-85 years &
%{ 7 weeks 118 $\mu$g folate/day then} 7 weeks 200 or 415 $\mu$g folate/day &
%Methyl acceptance assay &
%United States of America &
%{ Following folate depletion, increase in \textsuperscript{3}Hmethyl incorporation in all subjects (both 200 and 415 $\mu$g folate/day groups), but no difference between groups} ~ Following folate repletion, no change in \textsuperscript{3}Hmethyl incorporation within nor between 200 and 415 $\mu$g folate/day groups\\
%
%{Shelnutt }{\textit{et al}}{. 2004 \cite{c75}} &
%20 young women with \textit{MTHFR} 677CC or TT genotype &
%20-30 years
%& { 7 weeks 115\textrm{${\pm}$}20 
%$\mu$g DFE/day then} 7 weeks 400 $\mu$g DFE/day &
%Methyl acceptance assay &
%United States of America &
%No effect\\
%%\end{tabularx}
