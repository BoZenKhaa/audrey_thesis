...
\parbox[t][5.2cm]{2.1cm}{\centering Extremes of plasma folate (10th and 90th percentiles)} &
\parbox[t][5.2cm]{2.1cm}{\centering LINE-1 methylation in peripheral blood leukocytes} & 
\parbox[t][5.2cm]{4cm}{ \centering - No difference in LINE-1 methylation between the 10th percentile and the 90th percentile of plasma folate\\
...
\hline
\parbox[t][2.5cm]{1.8cm}{\raggedright Fenech \textit{et al}. 1998 \cite{c796}} &
\parbox[t][2.5cm]{1.6cm}{\centering 63 volunteers} &
\parbox[t][2.5cm]{1.6cm}{\centering 18-32 years} &
\parbox[t][2.5cm]{1.8cm}{\centering 2000 $\mu$g folic acid and 20 $\mu$g vitamin B12} &
\parbox[t][2.5cm]{1.3cm}{\centering 12 weeks} &
\parbox[t][2.5cm]{3.2cm}{\centering Methyl acceptance assay} &
\parbox[t][2.5cm]{1.5cm}{\centering Australia} &
\parbox[t][2.5cm]{1.8cm}{\centering No effect}\\

\parbox[t][1.7cm]{1.8cm}{\raggedright Basten \textit{et al}. 2006 \cite{c797}} &
\parbox[t][1.7cm]{1.6cm}{\centering 61 volunteers} &
\parbox[t][1.7cm]{1.6cm}{\centering 20-60 years} &
\parbox[t][1.7cm]{1.8cm}{\centering 1200 $\mu$g folic acid} &
\parbox[t][1.7cm]{1.3cm}{\centering 12 weeks} &
\parbox[t][1.7cm]{3.2cm}{\centering Methyl acceptance assay} &
\parbox[t][1.7cm]{1.5cm}{\centering United Kingdom} &
\parbox[t][1.7cm]{1.8cm}{\centering No effect}\\

\parbox[t][2.3cm]{1.8cm}{\raggedright Jung \emph{et al}. 2011 \cite{c798} Chapter 4} &
\parbox[t][2.3cm]{1.6cm}{\centering 216 volunteers} &
\parbox[t][2.3cm]{1.6cm}{\centering 50-70 years} &
\parbox[t][2.3cm]{1.8cm}{\centering 800 $\mu$g folic acid} &
\parbox[t][2.3cm]{1.3cm}{\centering 3 years} &
\parbox[t][2.3cm]{3.2cm}{\centering Liquid chromatography electron spray tandem mass spectrometry (LC-ES MS/MS)} &
\parbox[t][2.3cm]{1.5cm}{\centering Netherlands} &
\parbox[t][2.3cm]{1.8cm}{\centering No effect}\\
\hline
%\end{tabularx}
\end{tabular}
\end{adjustbox}
...
\parbox[t][4.1cm]{3.5cm}{\centering day 1-5 195 $\mu$g folate/day; day 6-41 56 $\mu$g folate/day; day 42-69 111 $\mu$g folate/day; day 70-80 286 $\mu$g folate/day; day 81-91 516 $\mu$g folate/day} &
...
\parbox[t][2.5cm]{1.8cm}{\raggedright Gomes \textit{et al}. 2012 \cite{c79}} &
\parbox[t][2.5cm]{1.8cm}{\centering Dietary folate intake} &
\parbox[t][2.5cm]{2cm}{\centering Cross-sectional} &
\parbox[t][2.5cm]{2.2cm}{\centering 126 volunteers aged 60-88} &
\parbox[t][2.5cm]{2.7cm}{\centering Imprint Methylated DNA Quantification (ELISA based)} &
\parbox[t][2.5cm]{1.8cm}{\centering Brazil} &
\parbox[t][2.5cm]{2.7cm}{\centering No association}\\
