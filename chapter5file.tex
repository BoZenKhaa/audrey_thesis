\chapter[B vitamins and LINE-1 in a high risk population]{Plasma B vitamins and LINE-1 DNA methylation in leukocytes of patients  with a history of  colorectal adenomas}
\label{chap5_poliep} 
...
% TABLE 5.1 CONTINUED
\begin{table}
\caption*{{\bf{Table 5.1}} \emph{Continued}}
\label{table5_1}
\begin{adjustbox}{width=\textwidth}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{L{6.4cm}C{3cm}C{3cm}}
