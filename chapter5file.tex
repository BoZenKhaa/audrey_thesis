...
\begin{flushleft}
\small
\tablecaption{Dietary and lifestyle characteristics by number of lifetime adenomas.}
\label{table5_1}
\tablehead{}
...
\begin{landscape}
\small
\tablecaption{Associations between plasma B vitamins and LINE-1 methylation according to number of lifetime adenomas using multivariable linear regression.}
\label{table5_2}
\tablehead{}
...
~
 &
\multicolumn{2}{m{10.05cm}}{\centering
\bfseries 1 adenoma (n=149)} &
\multicolumn{2}{m{10.801cm}}{\centering
\bfseries ${\geq}$ 2 adenomas
(n=132)}\\\hline
~
 &
{ Unadjusted }
...
\begin{flushleft}
\small
\tablecaption{Associations between plasma B vitamins and LINE-1 methylation according to family history using multivariable linear regression.}
\label{table5_3}
\tablehead{}
...
CRC (n=81) &
% \centering\arraybslash % arraybslash doesn't work so comment out
\bfseries No
...
\begin{flushleft}
\small
\tablecaption{Associations between plasma B vitamins and LINE-1 methylation according to \emph{MTHFR} C677T genotype.}
\label{table5_4}
\tablehead{}
...
~
 &
\multicolumn{3}{m{11cm}}{\centering
...
\begin{flushleft}
\small
\tablecaption{Associations between plasma folate and LINE-1 methylation stratified by plasma riboflavin, smoking status, and alcohol intake using a multivariable regression model.}
\label{table5_5}
\tablehead{}
...
~
\\\hline
 1 (2.48-12.34 nmol/L) (n=87) &
{ {}-3.84}

 {}-6.27, -1.40\\\hline
 2 (12.35-24.19 nmol/L) (n=88) &
{ {}-1.16}
...
~
\\\hline
 1 (0.00-4.38 g/day) (n=90) &
{ {}-0.41}

 {}-2.73, 1.90\\\hline
 2 (4.39-17.90 g/day) (n=90) &
{ {}-3.56}

 {}-5.88, -1.04\\\hline
 3 (17.91-143.50 g/day) (n=90) &
{ {}-1.32}
